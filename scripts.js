      ...
      list.innerHTML = `
        <div style="background:#111;border:1px solid rgba(255,255,255,0.11);border-radius:10px;padding:16px 14px;margin-bottom:14px;">
          <div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:10px;">
            ...
            <button id="endHistInfoBtn" onclick="_endHistInfoToggle(event)" style="background:rgba(255,255,255,0.15);border:2.5px solid #fff;border-radius:50%;width:28px;height:28px;color:#fff;font-size:14px;font-weight:700;font-family:'Georgia',serif;cursor:pointer;flex-shrink:0;display:flex;align-items:center;justify-content:center;letter-spacing:0;box-shadow:0 2px 8px rgba(0,0,0,0.4);">i</button>
          </div>
